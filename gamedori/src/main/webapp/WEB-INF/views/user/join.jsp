				...
				<form class="validation-form" novalidate><!-- novalidate 속성이 있으면 서버에서 유효성 검사를 안한다고합니다. 조율 후에 변경해야 할 듯 함. -->
					...
					<div class="input-form input-form-background p-4">
						...
						<h3 class="mb-5">회원가입</h3>
							...
							<div class="mb-4">
								...
								<div class="input-group input_s">
									<input type="email" class="form-control" placeholder="ezen@it.com" required>
									<button class="btn btn-outline-secondary" type="button" id="MEMBER_EMAIL">중복체크</button>
						...
						<div class="d-flex flex-row-reverse input_s mt-4 mb-4">
							<button class="btn btn-outline-light login">가입 완료</button>
						</div>
					</div>
				</form>
			</div>
